...
const TwCalculator = defineAsyncComponent(
  () => import('./pages/tw-calculator/index.js'),
)
const TwDeviceBrowser = defineAsyncComponent(
  () => import('./pages/tw-device-browser/index.js'),
)
const InitiativeTracker = defineAsyncComponent(
  () => import('./pages/initiative-tracker/index.js'),
)
