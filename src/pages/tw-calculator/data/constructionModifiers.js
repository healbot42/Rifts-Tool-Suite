...
export const RIFTS_CONSTRUCTION_MODIFIERS = Object.freeze([
  ...
  { id: 'rush-job', label: 'Rush job', percent: 25, timeMultiplier: 2 / 3, timeExclusive: true, note: 'Work completed in two-thirds of the normal time.' },
  { id: 'extremely-rushed', label: 'Extremely rushed', percent: 50, timeMultiplier: 1 / 3, timeExclusive: true, note: 'Work completed in one-third of the normal time; cannot be combined with another construction-time penalty or bonus.' },
  { id: 'low-magic-environment', label: 'Low magic environment', percent: 15, timeMultiplier: 1, timeExclusive: true, note: 'Applies when most construction time is spent in low magic; cannot be combined with another construction-time penalty or bonus.' },
...
export const RIFTS_CONSTRUCTION_BONUSES = Object.freeze([
  ...
  { id: 'taking-time', label: 'Taking time', percent: 15, timeMultiplier: 4 / 3, timeExclusive: true, note: 'Adds one-third to construction time; cannot be combined with another construction-time penalty or bonus.' },
  { id: 'at-your-leisure', label: 'At your leisure', percent: 30, timeMultiplier: 2, timeExclusive: true, note: 'Doubles construction time; cannot be combined with another construction-time penalty or bonus.' },
