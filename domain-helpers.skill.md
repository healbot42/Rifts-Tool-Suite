...
Purpose
- Help AI agents maintain the pure calculator logic already extracted into `src/pages/tw-calculator/lib/calculations.js`.
...
- Input and output shapes that match the reactive state in `TwCalculator.vue`.
- Unit tests in `tests/pages/tw-calculator/calculations.test.js`.

How to behave
- Keep `TwCalculator.vue` focused on UI and state management.
